...
export default class SortableList extends Component {
  static propTypes = {
    leftColumnData: PropTypes.object.isRequired,
    rightColumnData: PropTypes.object.isRequired,
  ...
  state = {
    order: this.props.order || Object.keys(this.props.leftColumnData),
    order1: this.props.order1 || Object.keys(this.props.rightColumnData),
    rowsLayouts: null,
    containerLayout: null,
    leftColumnData: this.props.leftColumnData,
    rightColumnData: this.props.rightColumnData,
    activeRowKey: null,
    activeRowIndex: null,
    releasedRowKey: null,
        ...
        <ScrollView
          ...
          <View style={[styles.container, {height: contentHeight}]}>
            <View style={[styles.container_new]}>
              {this._renderRows(this.state.leftColumnData, this.state.order, 0, true)}
              {this._renderRows(this.state.rightColumnData, this.state.order1, this.props.width/2, true)}
            </View>
            <View style={[styles.container_new]}>
              {this._renderRows(this.state.leftColumnData, this.state.order, 0, false)}
              {this._renderRows(this.state.rightColumnData, this.state.order1, this.props.width/2, false)}
            </View>
          </View>
        </ScrollView>
      </Animated.View>
  ...
  _renderRows(data, order, _x, isBottom) {
    const {sortingEnabled, renderRow, onPress} = this.props;
  ...
  _onReleaseRow = (rowKey) => {
    ...
    var data = this.state.leftColumnData
    ...
    if (index1 == -1) {
      ...
      data = this.state.rightColumnData;
